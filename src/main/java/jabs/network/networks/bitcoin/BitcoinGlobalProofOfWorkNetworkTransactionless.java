...
public class BitcoinGlobalProofOfWorkNetworkTransactionless<R extends Enum<R>> extends
        GlobalProofOfWorkNetwork<BitcoinNode, BitcoinMinerNode, BitcoinBlockWithoutTx, R> {

    public BitcoinGlobalProofOfWorkNetworkTransactionless(RandomnessEngine randomnessEngine,
